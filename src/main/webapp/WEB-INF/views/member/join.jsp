...
function check() {
	...
	var confirm_passwd = document.getElementById("confirm_passwd");
		...
		<form name="form1" method="post" action="${path}/member/join.do">
			...
			<div class="form-group">
				비밀번호 재확인 <input class="form-control" placeholder="비밀번호"
					name="confirm_passwd" id="confirm_passwd" type="password" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				성명 <input class="form-control" placeholder="이름" name="name"
					id="name" type="text" />
			</div>
			...
			<div class="form-group">
				이메일 <input placeholder="이메일" name="email1"
					id="email1" type="text" /> @ <select name="email2" id="email2">
